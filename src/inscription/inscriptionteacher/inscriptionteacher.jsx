...
function Countries(){
   ...
   return <Select className='w-[260px]' styles={{control:base=>({...base,borderRadius:"12px",backgroundColor:"#ffffff83",height:"50px"})}} placeholder="Select Your countrie" options={options}></Select>
}
